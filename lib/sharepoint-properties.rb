...
module Sharepoint
  class ObjectProperties
    ...
    def is_property_editable? property_name
      # We don't know a priori what the fields are for a generic object or List Item, so leave the validation work to the user
      return true if self.is_a?(GenericSharepointObject) || self.is_a?(ListItem)
